...
class CanvasWrapper():
    def __init__(self):
        app.use_app("PyQt5")
        self.canvas = scene.SceneCanvas(size=CANVAS_SIZE, keys='interactive', bgcolor='white')
        ...
        self.view_top1.camera.set_range(x=(70, 135), y=(1, 5.5), margin=0)
        sf_vals = pos
        ...
        yaxis = scene.AxisWidget(orientation='left', axis_label='Objective function', axis_font_size=8, axis_label_margin=30, tick_label_margin=2, text_color='black', axis_color='black')
        yaxis.width_max = 50
        self.grid.add_widget(yaxis, row=0, col=0)
        yaxis.link_view(self.view_top1)

        # x_axis = scene.AxisWidget(orientation='bottom', axis_label='Step frequencies', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        x_axis = scene.AxisWidget(orientation='bottom', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        ...
        self.view_top2.camera.set_range(x=(70, 135), y=(0, 1), margin=0)
        ...
        yaxis2 = scene.AxisWidget(orientation='left', axis_label='Acquisition func.', axis_font_size=8, axis_label_margin=30, tick_label_margin=2, text_color='black', axis_color='black')
        yaxis2.width_max = 50
        self.grid.add_widget(yaxis2, row=2, col=0)
        yaxis2.link_view(self.view_top2)

        x_axis2 = scene.AxisWidget(orientation='bottom', axis_label='Step frequencies', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        ...
        yaxis3 = scene.AxisWidget(orientation='left', axis_label='Ci', axis_font_size=8, axis_label_margin=30, tick_label_margin=2, text_color='black', axis_color='black')
        yaxis3.width_max = 50
        self.grid.add_widget(yaxis3, row=4, col=0)
        yaxis3.link_view(self.view_bot)
        x_axis3 = scene.AxisWidget(orientation='bottom', axis_label='Time (%)', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        x_axis3.stretch = (1,0.2)
        self.grid.add_widget(x_axis3, row=5, col=1)
        x_axis3.link_view(self.view_bot)
        x_axis4 = scene.AxisWidget(orientation='bottom', axis_label='Time (%)', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        ...
        line_data7 = generate_compare_coefficients(NUM_LINE_POINTS,H[3])
        line_data8 = generate_compare_coefficients(NUM_LINE_POINTS,H2[3])
        ...
        yaxis4 = scene.AxisWidget(orientation='left', axis_label='Ci', axis_font_size=8, axis_label_margin=30, tick_label_margin=2, text_color='black', axis_color='black')
        yaxis4.width_max = 50
        self.grid.add_widget(yaxis4, row=6, col=0)
        yaxis4.link_view(self.view_bot3)
        x_axis5 = scene.AxisWidget(orientation='bottom', axis_label='Time (%)', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
        x_axis5.stretch = (1,0.2)
        self.grid.add_widget(x_axis5, row=7, col=1)
        x_axis5.link_view(self.view_bot3)
        x_axis6 = scene.AxisWidget(orientation='bottom', axis_label='Time (%)', axis_font_size=8, axis_label_margin=20, tick_label_margin=15, text_color='black', axis_color='black')
