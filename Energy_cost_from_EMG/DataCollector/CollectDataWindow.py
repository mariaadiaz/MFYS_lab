...
class CollectDataWindow(QWidget):
    ...
    def __init__(self,controller):
        ...
        self.processingConnector = ProcessingWindow()
        ...
        layout = QHBoxLayout()
        self.setStyleSheet("background-color:#1F253D;")
    ...
    def SetCallbackConnector(self):
        if self.plot_enabled and self.process_enabled:
            self.CallbackConnector = PlottingManagement(self.MetricsConnector, self.plotCanvas, self.process_enabled, self.processingConnector)
            self.processingConnector.show()
        elif self.plot_enabled:
            self.CallbackConnector = PlottingManagement(self.MetricsConnector, self.plotCanvas, None)
        elif self.process_enabled:
            self.CallbackConnector = PlottingManagement(self.MetricsConnector, None, self.process_enabled, self.processingConnector)
            self.processingConnector.show()
        else:
